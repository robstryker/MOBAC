...
public class ScriptMain {
	...
	private static void outputCommand(String squareId, EastNorthCoordinate point) {
		...
		sb.append("java -Xms64m -Xmx1024M -jar Mobile_Atlas_Creator.jar ");
	...
	private static EastNorthCoordinate moveGrid(MapSource source, int zoom, EastNorthCoordinate origin, int x, int y) {
		...
		return GridSelectionUtility.getDistanceGridPoint(source, source.getMapSpace(), MainGUI.getMainGUI().previewMap.getZoom(), origin, GridSelectionUtility.SOUTH, y);
	}
}
